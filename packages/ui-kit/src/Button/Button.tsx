  ...
  const iconSize =
    (typeof size === "number"
      ...
      : getFontSize(size as FontSizeTokens, {
          font:
            (fontFamily as any)?.[0] === "$" ? (fontFamily as any) : undefined,
        })) * scaleIcon;
...
//       //   width === "auto" && styles.widthAuto,
//       //   size === "md" && [styles.sizeMd, fontVariants.md],
//       //   size === "sm" && [styles.sizeSm, fontVariants.sm],
//       //   style || false,
//       // ]}
//       title={children}
//     />
